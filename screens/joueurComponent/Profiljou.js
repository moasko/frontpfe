...
const ProfilJou = ({route,navigation}) => {
    ...
    return ( 
       ...
       <View style={styles.rect}>
         ...
         <Text style={styles.specialite}></Text>
         <FeatherIcon name="edit" style={styles.icon} onPress={() => navigation.navigate('Modifier Profile joueur',{nom,email,id,motDepass,prenom})}></FeatherIcon>
       </View>
       <View style={styles.btn}>
         <View style={styles.cont}>
           <TouchableOpacity style={styles.buttonWrapper1} onPress={() =>navigation.navigate('votre liste de consultations',{id})} >
           ...
           <TouchableOpacity style={styles.buttonWrapper2} onPress={() =>navigation.navigate('Vos antécédents medicaux',{id:id})}>
           <MaterialIconsIcon
        name="create-new-folder"
        style={styles.ic2}
      ></MaterialIconsIcon>
             
             <Text style={styles.btn2Text}>Antecedent Medicaux</Text>
           </TouchableOpacity>
         </View>
       </View>
     </View>
